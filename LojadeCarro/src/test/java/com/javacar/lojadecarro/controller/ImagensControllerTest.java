...
class ImagensControllerTest {
    ...
    void deveCadastrarImagem() throws Exception {
        ...
        // Act + Assert
        mockMvc.perform(
                        multipart(URL + "/{idCarro}", ID_VALIDO)
                                .file(file1)
                                .file(file2)
                )
    ...
    void deveListarImagemPorID() throws Exception {
        ...
        //Act + Assert
        mockMvc.perform(
                        get(URL + "/carro/{idCarro}", ID_VALIDO)
    ...
    void deveRetornar404AoBuscarImagemPorID() throws Exception {
        ...
        when(imagensService.listarImagens(ID_INVALIDO))
                .thenThrow(new ImagensException(ID_INVALIDO));
        //Act + Assert
        mockMvc.perform(
                get(URL + "/carro/{idCarro}", ID_INVALIDO)
    ...
    void  deveBuscarImagemPorID() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.idCarro").value(ID_VALIDO));
    ...
    void deveDeletarImagenPorID() throws Exception {
        //Arrange
        doThrow(new ImagensException(ID_INVALIDO))
