...
//                .thenThrow(new CombustivelNotFoundException(ID_INVALIDO));
//
//        //Act + Assert
//        mockMvc.perform(
//                        get(URL + "/" + ID_INVALIDO)
...
//        verify(combustivelService).alterarStatus(ID_VALIDO);
//    }
//
//    @Test
...
//        //Arrange
//        doThrow(new CombustivelNotFoundException(ID_INVALIDO))
//                .when(combustivelService).alterarStatus(ID_VALIDO);
//        //Act + Assert
//        mockMvc.perform(
//                        delete(URL + "/" + ID_VALIDO)
//                ).andExpect(status().isNotFound())
