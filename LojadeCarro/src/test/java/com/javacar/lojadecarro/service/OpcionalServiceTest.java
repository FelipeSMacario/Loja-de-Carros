...
//                .thenReturn(entity);
//
//        when(carroService.buscaCarro(request.idVeiculo()))
...
//                .thenReturn(entity);
//        when(carroService.buscaCarro(request.idVeiculo()))
//                .thenThrow(new CarroException(request.idVeiculo()));
//        //Act
...
//        verify(kitMapper, times(2)).toResponse(any(Opcional.class));
//
//
...
//        verify(carroService).buscaCarro(request.idVeiculo());
//        verify(kitRepository).save(entity);
//        verify(kitMapper).toResponse(entity);
//
//        verifyNoMoreInteractions(
...
//    }
//
//    private Opcional criarKitEntity() {
...
//    }
//
//    private Veiculo criarCarroEntity() {
