...
import com.JavangularCar.LojadeCarro.factory.combustivel.CombustivelRequestFactory;
import com.JavangularCar.LojadeCarro.factory.combustivel.CombustivelResponseFactory;
...
public class CombustivelServiceTest {
    ...
    public static final String MSG_COMBUSTIVEL_NAO_ENCOTRADO = "Combustível não encontrado com o id: ";
    ...
    void deveAtualizarCombustivel() {
        ...
        //Act
        var resultado = combustivelService.findCombustivelById(ID_COMBUSTIVEL);
